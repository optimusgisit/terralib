...
#
#
#  Description: Install all required software for TerraLib/TerraView on macOS Sierra.
#
#  Author: Gilberto Ribeiro de Queiroz
#
#
#  Example:
#  $ TERRALIB_DEPENDENCIES_DIR="/Users/gribeiro/MyLibs" ./install-3rdparty-macosx-sierra.sh
#

clear

echo "**********************************************"
echo "* TerraLib Installer for macOS Sierra        *"
echo "**********************************************"
echo ""
sleep 1s
...
#
# Check for terralib-3rdparty-macosx-sierra.tar.gz
#
if [ ! -f ./terralib-3rdparty-macosx-sierra.tar.gz ]; then
  echo "Please, make sure to have terralib-3rdparty-macosx-sierra.tar.gz in the current directory!"
  exit
fi
...
tar xzvf terralib-3rdparty-macosx-sierra.tar.gz > /dev/null 2> /dev/null
valid $? "Error: could not extract 3rd party libraries (terralib-3rdparty-macosx-sierra.tar.gz)"
...
#
cd terralib-3rdparty-macosx-sierra > /dev/null
valid $? "Error: could not enter 3rd-party libraries dir (terralib-3rdparty-macosx-sierra)"
